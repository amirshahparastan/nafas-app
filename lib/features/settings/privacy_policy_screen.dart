      ...
      body: ListView(
        ...
        children: [
          ...
          const _PolicySection(
            ...
            body:
                'اطلاعاتی که خودت برای استفاده از امکانات برنامه وارد می‌کنی می‌تواند شامل الگوی مصرف سیگار، تاریخ شروع ترک، هدف مالی، ثبت هوس، یادداشت‌ها، نام اختیاری داخل برنامه، تنظیمات و اطلاعات فرد مورد اعتماد باشد.',
          ),
          const _PolicySection(
            title: '۲. اطلاعات فعلی کجا نگهداری می‌شوند؟',
            body:
                'در نسخه ۱.۰ داده‌های اصلی تجربه ترک به‌صورت محلی روی دستگاه نگهداری می‌شوند. حساب کاربری، بکاپ ابری و همگام‌سازی فعال نیست؛ بنابراین نفس این داده‌ها را برای پشتیبان‌گیری به سرور ارسال نمی‌کند.',
          ),
          const _PolicySection(
          ...
          const _PolicySection(
            ...
            body:
                'نفس اطلاعات ترک، سلامت یا هویت خصوصی کاربران را برای تبلیغات هدفمند جمع‌آوری یا به فروش نمی‌رساند و این اطلاعات را به‌صورت عمومی نمایش نمی‌دهد. دیوار امید در نسخه ۱.۰ هنوز فعال نشده است.',
          ),
          const _PolicySection(
            title: '۵. حذف و کنترل داده‌ها',
            body:
                'کاربر می‌تواند از بخش «حریم خصوصی و داده‌ها» اطلاعات محلی این دستگاه را حذف کند و برنامه را از ابتدا شروع کند. در صورت اضافه‌شدن حساب و همگام‌سازی ابری، این سیاست پیش از فعال‌شدن آن قابلیت به‌روزرسانی خواهد شد.',
          ),
          const _PolicySection(
