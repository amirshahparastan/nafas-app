      ...
      body: ListView(
        ...
        children: [
          ...
          const _TermSection(
            ...
            body:
                'دیوار امید در نسخه ۱.۰ فعال نیست. در زمان فعال‌شدن این قابلیت، قوانین جامعه، گزارش محتوا و سازوکار مدیریت آن پیش از استفاده در دسترس کاربر قرار می‌گیرد و اطلاعات خصوصی دیگران نباید بدون اجازه منتشر شود.',
          ),
          const _TermSection(
