            ...
            NafasCard(
              child: Column(
                children: [
                  Row(
                    children: [
                      IconButton(tooltip: 'ماه قبل', onPressed: () => setState(() => visible = visible.previousMonth()), icon: const Icon(Icons.chevron_right_rounded)),
                      ...
                      IconButton(tooltip: 'ماه بعد', onPressed: () => setState(() => visible = visible.nextMonth()), icon: const Icon(Icons.chevron_left_rounded)),
                    ],
                  ),
