      ...
      body: SafeArea(
        ...
        child: ListView(
          ...
          children: [
            ...
            _tile(Icons.smoke_free_rounded, 'اطلاعات مصرف', 'تعداد روزانه، قیمت پاکت و تاریخ شروع جلالی', onTap: () => _info(context)),
            _tile(Icons.calendar_month_rounded, 'تقویم نفس', 'نمای ماهانه جلالی با روزهای پاک، هوس و لغزش', onTap: () => Navigator.pushNamed(context, '/calendar')),
            _tile(Icons.edit_note_rounded, 'حال امروز', 'ژورنال کوتاه و بدون فشار', onTap: () => Navigator.pushNamed(context, '/journal')),
            ...
            _tile(Icons.info_outline_rounded, 'درباره نفس', 'نسخه ۰.۴.۰ • Persian-first Product Polish'),
