...
class NafasAppState extends ChangeNotifier {
  ...
  void setTab(int index) { selectedMainTab = index.clamp(0, 4).toInt(); notifyListeners(); }
  ...
  void removeGoal() { hasGoal = false; notifyListeners(); }
  void toggleReminders(bool value) { remindersEnabled = value; notifyListeners(); }
...
extension _IterableFirstOrNull<T> on Iterable<T> {
  T? get firstOrNull { final iterator = this.iterator; if (!iterator.moveNext()) return null; return iterator.current; }
}
