                    ...
                    Container(
                      ...
                      child: const Row(
                        children: [
                          ...
                          _MetricDivider(),
                          Expanded(child: _HeroMetric(value: '۱.۸م', label: 'پس‌انداز')),
                        ],
                      ),
                    ),
                  ],
        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(labelText: 'مبلغ هدف (تومان)', prefixIcon: Icon(Icons.payments_outlined)),
            ),
            const SizedBox(height: 16),
            Wrap(
              spacing: 8,
...
class _IntroFeature extends StatelessWidget {
  const _IntroFeature({required this.icon, required this.title, required this.subtitle});
  final IconData icon;
  final String title;
      ...
      child: Row(
        ...
        children: [
          Container(
            width: 44,
            height: 44,
            decoration: BoxDecoration(color: NafasColors.surfaceSoft, borderRadius: BorderRadius.circular(14)),
